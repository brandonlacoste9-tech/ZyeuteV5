...
const QUEBEC_VIDEOS = [
  ...
  {
    caption: "❄️ L'hiver au Québec, c'est ça! La neige qui tombe doucement sur Montréal 🌨️",
  ...
  {
    caption: "🎨 La culture street art de Montréal! Notre ville est un musée à ciel ouvert 🖌️",
  ...
  // Language & Identity
  {
    caption: "🗣️ Le joual, c'est notre identité! Tabarnouche qu'on est fiers! ⚜️",
  ...
  {
    caption: "⚜️ Fleurdelisé! Notre drapeau, notre fierté. Vive le Québec libre! ⚜️",
...
async function populate() {
  console.log("⚜️ Populating Zyeuté Quebec Feed via HTTP API (Plain JS)...\n");
