...
function detectIntent(message: string): string {
  ...
  if (lowerText.includes('allo') || lowerText.includes('salut') || lowerText.includes('bonjour') || lowerText.includes('yo') || lowerText.includes('heille')) {
    return 'greeting';
  }
  if (lowerText.includes('upload') || lowerText.includes('poster') || lowerText.includes('publier') || lowerText.includes('créer') || lowerText.includes('photo') || lowerText.includes('vidéo')) {
    return 'upload';
  }
  if (lowerText.includes('feu') || lowerText.includes('fire') || lowerText.includes('like') || lowerText.includes('aimer')) {
    return 'fire';
  }
  if (lowerText.includes('story') || lowerText.includes('histoire') || lowerText.includes('stories')) {
    return 'story';
  }
  if (lowerText.includes('québec') || lowerText.includes('quebec') || lowerText.includes('montréal') || lowerText.includes('montreal') || lowerText.includes('514') || lowerText.includes('450')) {
    return 'quebec';
  }
  if (lowerText.includes('cadeau') || lowerText.includes('gift') || lowerText.includes('tip') || lowerText.includes('donner')) {
    return 'gifts';
  }
  if (lowerText.includes('premium') || lowerText.includes('vip') || lowerText.includes('abonnement') || lowerText.includes('subscription')) {
    return 'premium';
  }
  if (lowerText.includes('aide') || lowerText.includes('help') || lowerText.includes('comment') || lowerText.includes('comment ça marche') || lowerText.includes('explique')) {
    return 'help';
  }
