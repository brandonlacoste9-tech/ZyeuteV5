...
const GlobalAuthLoader: React.FC<{ children: React.ReactNode }> = ({ children }) => {
                            ...
                            <BrowserRouter>
                              ...
                              <Suspense fallback={<LoadingScreen />}>
                                <Routes>
                                  ...
                                  <Route path="/zyeute" element={<ProtectedRoute><Suspense fallback={<LazyLoadFallback />}><LaZyeute /></Suspense></ProtectedRoute>} />
                                    ...
                                    <MainLayout>
                                      <PageTransition>
                                        <Routes>
                                          ...
                                          <Route path="/feed" element={<ProtectedRoute><RouteErrorBoundary><Feed /></RouteErrorBoundary></ProtectedRoute>} />
                                          <Route path="/explore" element={<ProtectedRoute><RouteErrorBoundary><Explore /></RouteErrorBoundary></ProtectedRoute>} />
                                          <Route path="/upload" element={<ProtectedRoute><RouteErrorBoundary><Suspense fallback={<LazyLoadFallback />}><Upload /></Suspense></RouteErrorBoundary></ProtectedRoute>} />
                                          <Route path="/story/create" element={<ProtectedRoute><Suspense fallback={<LazyLoadFallback />}><StoryCreator /></Suspense></ProtectedRoute>} />
                                          <Route path="/p/:id" element={<ProtectedRoute><Suspense fallback={<LazyLoadFallback />}><PostDetail /></Suspense></ProtectedRoute>} />
                                          ...
                                          <Route path="/live/*" element={<ProtectedRoute><LiveDiscover /></ProtectedRoute>} />
                                          <Route path="/moderation" element={<ProtectedAdminRoute><Moderation /></ProtectedAdminRoute>} />
                                          ...
                                          <Route path="/revenue" element={<ProtectedRoute><CreatorRevenue /></ProtectedRoute>} />
