...
export const Logo: React.FC<LogoProps> = ({
  ...
  const sizeConfig = {
    sm: { container: 'w-10 h-10', icon: 'w-6 h-6', text: 'text-lg', blur: '8px', stitch: '3px' },
    md: { container: 'w-14 h-14', icon: 'w-8 h-8', text: 'text-2xl', blur: '12px', stitch: '4px' },
    lg: { container: 'w-20 h-20', icon: 'w-12 h-12', text: 'text-3xl', blur: '16px', stitch: '5px' },
    xl: { container: 'w-28 h-28', icon: 'w-16 h-16', text: 'text-5xl', blur: '24px', stitch: '6px' },
  };
    ...
    <div className={`flex flex-col items-center gap-2 ${className}`}>
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="absolute top-1 left-1 w-2 h-2 border-t-2 border-l-2 rounded-tl" style={{ borderColor: 'rgba(255,215,0,0.7)', borderStyle: 'dashed' }} />
          <div className="absolute top-1 right-1 w-2 h-2 border-t-2 border-r-2 rounded-tr" style={{ borderColor: 'rgba(255,215,0,0.7)', borderStyle: 'dashed' }} />
          <div className="absolute bottom-1 left-1 w-2 h-2 border-b-2 border-l-2 rounded-bl" style={{ borderColor: 'rgba(255,215,0,0.7)', borderStyle: 'dashed' }} />
          <div className="absolute bottom-1 right-1 w-2 h-2 border-b-2 border-r-2 rounded-br" style={{ borderColor: 'rgba(255,215,0,0.7)', borderStyle: 'dashed' }} />
          ...
          >
            <defs>
              ...
              <filter id="embroideryGlow" x="-50%" y="-50%" width="200%" height="200%">
            ...
            <g fill="url(#goldThread)" stroke="url(#goldHighlight)" strokeWidth="2" filter="url(#embroideryGlow)">
              {/* Center Petal */}
            ...
            {/* Stitch detail lines */}
            <g stroke="rgba(255,248,220,0.5)" strokeWidth="0.5" strokeDasharray="2,2" fill="none">
        ...
        {size === 'xl' && (
          <p 
            ...
            style={{ 
              color: '#DAA520',
              textShadow: glowing ? '0 0 10px rgba(255,215,0,0.6), 0 1px 2px rgba(0,0,0,0.8)' : '0 1px 2px rgba(0,0,0,0.8)',
            }}
          >
            QUÉBEC
          </p>
