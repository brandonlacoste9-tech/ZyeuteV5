  ...
  return (
    <nav
      ...
      style={{
        ...
        boxShadow: '0 -10px 40px rgba(0,0,0,0.8), 0 -2px 20px rgba(255, 191, 0, 0.15)',
        borderTop: '1px solid rgba(255, 191, 0, 0.4)',
      }}
    >
      {/* Gold Glow Line at Top */}
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-gold-500/60 to-transparent" style={{ boxShadow: '0 0 15px rgba(255, 191, 0, 0.5)' }} />
