...
export const QuebecHashtags: React.FC = () => {
    const trendingTags: TrendingTag[] = [
        { tag: '#Poutine', count: 1243, trending: true, region: 'Québec', category: 'food' },
        { tag: '#Québec', count: 892, trending: true, region: 'Québec', category: 'culture' },
        { tag: '#Montréal', count: 756, trending: false, region: 'Montréal', category: 'culture' },
        { tag: '#GoHabsGo', count: 543, trending: true, region: 'Montréal', category: 'sports' },
        { tag: '#CultureQC', count: 432, trending: false, region: 'Québec', category: 'culture' },
        { tag: '#FEQ2024', count: 321, trending: true, region: 'Québec', category: 'culture' },
        { tag: '#Gaspésie', count: 287, trending: false, region: 'Gaspésie', category: 'nature' },
        { tag: '#Tourtière', count: 254, trending: false, region: 'Québec', category: 'food' },
    ];
        ...
        <div className="mb-10">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">Découvrez ce qui buzz en ce moment</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {trendingTags.map((item) => (
                    <div
                        key={item.tag}
                        className={`p-4 rounded-xl border ${item.trending
