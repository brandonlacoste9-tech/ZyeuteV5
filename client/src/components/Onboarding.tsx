...
const steps: OnboardingStep[] = [
  {
    ...
    subtitle: 'Zyeuté, c\'est l\'app sociale du Québec. Crée, partage, pis connecte-toi avec du monde d\'icitte.',
    icon: (
      <svg viewBox="0 0 100 100" className="w-20 h-20" style={{ filter: 'drop-shadow(0 0 15px rgba(255,191,0,0.6))' }}>
        <defs>
  ...
  },
  {
    ...
    subtitle: 'J\'suis ton assistant québécois. J\'peux t\'aider à créer des légendes, générer des images avec l\'IA, pis plein d\'autres affaires!',
    icon: (
  ...
  },
  {
    ...
    subtitle: 'Icitte, on "fire" au lieu de liker. Plus t\'as de feux, plus ton contenu est hot! C\'est simple de même.',
    icon: (
      <div className="relative">
        <span className="text-7xl animate-pulse" style={{ filter: 'drop-shadow(0 0 20px rgba(255, 100, 0, 0.6))' }}>🔥</span>
      </div>
    ),
  },
  {
    id: 'studio',
    title: 'Ti-Guy Studio ✨',
    subtitle: 'Crée des images avec l\'IA, anime tes photos en vidéo, pis laisse Ti-Guy t\'écrire des légendes qui claquent!',
    icon: (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-xl">
      ...
      <div className="relative w-full max-w-md mx-4">
        ...
        <div className="space-y-3">
          {/* Main action */}
          <button
            onClick={() => isLastStep && step.action ? handleComplete(true) : handleNext()}
