...
import { List, useDynamicRowHeight, ListImperativeAPI, RowComponentProps } from 'react-window';
...
const Row = React.memo(({ index, style, ariaAttributes, comments, postId, currentUser, setRowHeight }: RowComponentProps<ItemData>) => {
      ...
      <AutoSizer>
        {({ height, width }) => (
          <List<ItemData>
            ...
            rowComponent={Row as unknown as (props: RowComponentProps<ItemData>) => React.ReactElement}
            rowProps={{
              comments,
              postId,
              currentUser,
