...
export const MapleSpinner: React.FC<MapleSpinnerProps> = ({ className, size = 'md' }) => {
    const sizeClasses = {
        sm: 'w-6 h-6',
        md: 'w-12 h-12',
        lg: 'w-20 h-20',
    ...
    return (
        <div className={cn("relative flex items-center justify-center", sizeClasses[size], className)} role="status" aria-label="Chargement">
            {/* Outer Ring Pulse */}
