  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Login Card - Premium Leather with Gold Stitching */}
        <div 
          className="rounded-3xl p-8 relative"
          style={{
            background: `
              radial-gradient(ellipse at 30% 20%, rgba(80, 60, 45, 0.15) 0%, transparent 50%),
        ...
        >
          {/* Gold Stitching Border - Double Layer */}
          <div 
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              <span className="relative z-10 flex items-center justify-center gap-2">
                {isLoading ? (
                  <>
                    <span className="spinner-gold" style={{ width: '20px', height: '20px', borderWidth: '2px' }} />
                    {copy.auth.loggingIn}
                  </>
                ) : (
