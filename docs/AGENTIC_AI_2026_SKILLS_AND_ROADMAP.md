...
Copilot that _does_ things: suggest captions, validate design, search trends, get help. Use **CopilotKit**; expose Ti-Guy + tools (`validate_design`, `search_trends`, `get_help`, `suggest_caption`). French/Joual tone.
