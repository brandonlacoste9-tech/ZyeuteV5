...
1. Get your **database password** from: **https://app.supabase.com/project/[REF]/settings/database** (or reset it there).
...
- **Session (port 5432)** – direct: `postgresql://postgres:[YOUR-PASSWORD]@db.[REF].supabase.co:5432/postgres`
