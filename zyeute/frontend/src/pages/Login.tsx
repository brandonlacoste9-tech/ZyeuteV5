...
import { getCurrentUser, signIn, signInWithGoogle } from "../lib/legacySupabase";
        ...
        <div className="text-center mb-10 overflow-visible">
          <div className="relative inline-block overflow-visible">
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(255,191,0,0.6) 0%, transparent 70%)",
                transform: "scale(1.5)",
              }}
            />
            ...
            >
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 0 20px rgba(255,191,0,0.4), inset 0 0 20px rgba(255,191,0,0.1)",
                }}
              />
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 0 8px rgba(255, 215, 0, 0.4), inset 0 0 6px rgba(255, 215, 0, 0.2)",
            }}
          />
