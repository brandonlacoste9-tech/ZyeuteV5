...
export default function ArcadeHub() {
  ...
  const games = [
    {
      id: "poutine-royale",
      title: t("arcade.games.poutine.title"),
      description: t("arcade.games.poutine.desc"),
      icon: <FaGamepad className="w-12 h-12 text-yellow-500" />,
      status: t("arcade.status.live"),
      path: "/games/poutine",
    },
    {
      id: "hive-tap",
      title: t("arcade.games.hive.title"),
      description: t("arcade.games.hive.desc"),
    ...
    {
      id: "trivia",
      title: t("arcade.games.trivia.title"),
      description: t("arcade.games.trivia.desc"),
      icon: <FaQuestionCircle className="w-12 h-12 text-blue-500" />,
      status: t("arcade.status.soon"),
      path: null,
    },
  ];
      ...
      <div className="max-w-6xl mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {games.map((game) => (
          <motion.div
            ...
            className={`bg-gray-900 border-2 rounded-xl p-6 relative overflow-hidden group ${game.status === t("arcade.status.live")
          ...
          >
            ...
            {game.status === t("arcade.status.live") && (
