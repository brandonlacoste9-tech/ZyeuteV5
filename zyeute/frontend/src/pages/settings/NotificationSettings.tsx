...
export const NotificationSettings: React.FC = () => {
  ...
  const handleToggle = (
    path:
      ...
      | "notifications.notifyComments"
      | "notifications.notifyFires"
      | "notifications.notifyFollows",
    value: boolean,
  ) => {
    tap();
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-leather-300 text-sm">
                Recevoir des notifications sur ton appareil
              </p>
            </div>
            <button
              onClick={() =>
        ...
        <div className="leather-card rounded-xl p-4 stitched">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-leather-300 text-sm">
                Recevoir un résumé hebdomadaire par courriel
              </p>
            </div>
            <button
              onClick={() =>
                handleToggle(
                  "notifications.emailDigest",
                  !preferences.notifications.emailDigest,
                )
              }
              className={`relative w-14 h-8 rounded-full transition-colors ${
                preferences.notifications.emailDigest
        ...
        <div className="leather-card rounded-xl p-4 stitched">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-leather-300 text-sm">
                Rappels pour publier et interagir
              </p>
            </div>
            <button
              onClick={() =>
        ...
        <div className="leather-card rounded-xl p-4 stitched">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-leather-300 text-sm">
                Recevoir des notifications pour les commentaires
              </p>
            </div>
            <button
              onClick={() =>
                handleToggle(
                  "notifications.notifyComments",
                  !preferences.notifications.notifyComments,
                )
              }
              className={`relative w-14 h-8 rounded-full transition-colors ${
                preferences.notifications.notifyComments
        ...
        <div className="leather-card rounded-xl p-4 stitched">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-leather-300 text-sm">
                Recevoir des notifications pour les feux (likes)
              </p>
            </div>
            <button
              onClick={() =>
                handleToggle(
                  "notifications.notifyFires",
                  !preferences.notifications.notifyFires,
                )
              }
              className={`relative w-14 h-8 rounded-full transition-colors ${
                preferences.notifications.notifyFires
        ...
        <div className="leather-card rounded-xl p-4 stitched">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-leather-300 text-sm">
                Recevoir des notifications pour les nouveaux abonnés
              </p>
            </div>
            <button
              onClick={() =>
                handleToggle(
                  "notifications.notifyFollows",
                  !preferences.notifications.notifyFollows,
                )
              }
              className={`relative w-14 h-8 rounded-full transition-colors ${
                preferences.notifications.notifyFollows
