              ...
              <div className="grid grid-cols-4 gap-4">
                {[
                  ...
                  <button
                    ...
                    className={`relative group aspect-square rounded-2xl border-2 transition-all hover:scale-105 active:scale-95 flex items-center justify-center overflow-hidden ${borderColor.toUpperCase() === preset.color.toUpperCase()
