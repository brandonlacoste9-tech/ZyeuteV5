 ...
 * 
 * Use `@/lib/legacySupabase` instead. This file is kept for internal implementation
 * and will be removed once Clerk + Neon are fully integrated.
 * 
...
// ⚠️ INTERNAL USE ONLY - Import from legacySupabase.ts instead
...
// Helper to get enhanced video URL from post
// Uses enhanced_url if available, falls back to media_url
export function getEnhancedVideoUrl(post: { enhanced_url?: string | null; media_url?: string; mediaUrl?: string }): string {
  return post.enhanced_url || post.media_url || post.mediaUrl || "";
}

// Helper to get thumbnail URL from post
// Uses thumbnail_url if available, falls back to media_url
export function getThumbnailUrl(post: { thumbnail_url?: string | null; thumbnailUrl?: string | null; media_url?: string; mediaUrl?: string }): string {
  return post.thumbnail_url || post.thumbnailUrl || post.media_url || post.mediaUrl || "";
}
