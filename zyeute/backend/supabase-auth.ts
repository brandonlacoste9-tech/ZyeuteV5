/**
 * LEGACY SUPABASE AUTH UTILITY
 * 
 * TODO: Remove once Clerk is fully integrated
 * This file provides minimal JWT verification for backwards compatibility.
 * All new code should use the auth abstraction layer.
 */
...
if (!isSupabaseConfigured) {
  ...
  console.warn(
    "   TODO: Replace with Clerk authentication once integrated.",
  );
}
...
export async function verifyAuthToken(token: string): Promise<string | null> {
  ...
  if (!supabaseAdmin) {
    ...
    console.warn("TODO: Replace with Clerk session verification");
    return null;
  }
