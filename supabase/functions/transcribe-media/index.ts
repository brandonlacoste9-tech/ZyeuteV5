...
serve(async (req) => {
    try {
        ...
        formData.append('prompt', 'Transcription en français québécois (joual). Inclure les expressions locales comme: toé, icitte, moé, asteure, jsuis, chu, pis, là.') // Joual context
