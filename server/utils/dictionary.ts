...
const JOUAL_MAP: Record<string, Partial<DictionaryEntry>> = {
  ...
  "blonde": {
    definition: "Une petite amie ou une conjointe (peu importe la couleur de ses cheveux).",
    partOfSpeech: "nom féminin",
    synonyms: ["copine", "conjointe", "amoureuse"],
    quebecVariant: "Utilisé universellement au Québec au lieu de 'petite amie'."
  },
  "gosser": {
    definition: "Fatiguer quelqu'un, ennuyer ou travailler maladroitement sur un objet.",
    partOfSpeech: "verbe",
  ...
  "magané": {
    ...
    quebecVariant: "Très fréquent pour décrire un objet brisé ou une gueule de bois."
  },
  "tuque": {
  ...
  "breuvage": {
    ...
    quebecVariant: "Utilisé au Québec là où la France dirait simplement 'boisson'."
  },
  "char": {
  ...
  "poutine": {
    definition: "Plat national du Québec composé de frites, de fromage en grain et de sauce brune.",
    partOfSpeech: "nom féminin",
    synonyms: ["délice", "mets national"],
    quebecVariant: "Né dans le Centre-du-Québec dans les années 50."
  },
  "calisse": {
    definition: "Sacre québécois utilisé pour exprimer la colère ou la surprise.",
