    ...
    >
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            to="/arcade"
            className="p-2 mr-1 rounded-full bg-[#1a0f2e] border border-cyan-500/50 hover:bg-cyan-900/40 hover:scale-110 transition-all group flex items-center justify-center shadow-[0_0_10px_rgba(6,182,212,0.3)] hover:shadow-[0_0_15px_rgba(6,182,212,0.6)]"
            aria-label="Arcade"
          >
            <svg
