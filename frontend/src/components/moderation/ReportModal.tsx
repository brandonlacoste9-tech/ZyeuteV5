      ...
      <div className="w-full max-w-2xl max-h-[90vh] bg-gray-900 md:rounded-2xl overflow-hidden card-edge">
        ...
        <div className="p-6 border-b border-white/10 bg-gradient-to-r from-red-900/20 to-orange-900/20">
          ...
          <p className="text-white/70 text-sm">
            Aide-nous à garder Zyeuté sécuritaire pour tous. Ton signalement est
            confidentiel.
          </p>
        </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/80 text-xs leading-relaxed">
                  ...
                  <span className="text-red-400 font-bold">tolérance zéro</span>{" "}
                  concernant toute forme de leurre, grooming ou interaction
                  inappropriée impliquant des mineurs. Toute tentative détectée
                  entraîne la désactivation permanente du compte et le
                  signalement requis.
                </p>
              </div>
            </div>
