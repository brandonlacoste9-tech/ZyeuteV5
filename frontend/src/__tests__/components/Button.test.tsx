...
import { Button, PlayButton, FireButton } from "../../components/Button";
...
describe("Button Component", () => {
  ...
  describe("FireButton", () => {
    it("should render fire button with level", () => {
      ...
      expect(
        screen.getByLabelText("Give 3 fires - Praise this post"),
      ).toBeInTheDocument();
    });
    ...
    it("should call onClick when clicked", async () => {
      ...
      await user.click(
        screen.getByLabelText("Give 2 fires - Praise this post"),
      );
