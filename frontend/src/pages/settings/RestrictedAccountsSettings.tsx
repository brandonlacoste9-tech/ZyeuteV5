...
const restrictedAccountsSettingsLogger = logger.withContext(
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="leather-card rounded-xl p-4 stitched bg-gold-500/10 border border-gold-500/30">
          <p className="text-white text-sm">
            Les comptes restreints peuvent voir tes posts publics mais ne
            peuvent pas voir quand tu es en ligne ou si tu as lu leurs messages.
          </p>
        </div>
            ...
            <div className="mt-3 space-y-2">
              {searchResults.map((user) => (
                ...
                >
                  ...
                  >
                    {restrictedAccounts.includes(user.id)
                      ? "Restreint"
                      : "Restreindre"}
                  </button>
                </div>
        ...
        {restrictedAccounts.length > 0 && (
          <div className="leather-card rounded-xl p-4 stitched">
            <h3 className="text-white font-semibold mb-3">
              Comptes restreints ({restrictedAccounts.length})
            </h3>
