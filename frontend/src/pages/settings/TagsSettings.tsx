...
export const TagsSettings: React.FC = () => {
  ...
  const handleToggle = (
    path: "tags.allowTagging" | "tags.requireApproval",
    value: boolean,
  ) => {
    tap();
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-leather-300 text-sm">
                Permettre aux autres de te taguer dans leurs posts
              </p>
            </div>
            <button
              onClick={() =>
          ...
          <div className="leather-card rounded-xl p-4 stitched">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-leather-300 text-sm">
                  Approuver les tags avant qu&apos;ils apparaissent
                </p>
              </div>
              <button
                onClick={() =>
                  handleToggle(
                    "tags.requireApproval",
                    !preferences.tags.requireApproval,
                  )
                }
                className={`relative w-14 h-8 rounded-full transition-colors ${
                  preferences.tags.requireApproval
