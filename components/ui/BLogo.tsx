  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #FF3333 0%, #FF0000 50%, #CC0000 100%)",
          boxShadow:
            "0 4px 12px rgba(255, 0, 0, 0.4), 0 0 20px rgba(255, 0, 0, 0.2)",
        }}
      />
      {/* Silver coin body */}
      <div
        ...
        style={{
          ...
          bottom: "6%",
          background:
            "radial-gradient(circle at 35% 35%, #F5F5F5 0%, #E0E0E0 40%, #C0C0C0 70%, #A8A8A8 100%)",
          boxShadow:
